...
LEFT JOIN base_cancelamentos b 
    ...
    AND b.ts_previsto <= (a.ts_previsto - INTERVAL 5 HOUR) -- 5 HORAS ANTES DO HORÁRIO PREVISTO, POIS 1 HORA ANTES É O MOMENTO DA PREVISAO E CONSIDERAMOS OS VOOS CANCELADOS APENAS 4 HORAS APOS O HORARIO PREVISTO. OU SEJAM AMOSTRA DEVE SER 5 HRS ANTES PARA EVITAR DATA LEAKAGE
